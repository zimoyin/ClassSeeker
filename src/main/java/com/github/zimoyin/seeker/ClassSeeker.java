...
import com.github.zimoyin.seeker.find.FindClass;
import com.github.zimoyin.seeker.reference.ClassReaderUtil;
...
public final class ClassSeeker {
     ...
     * <p>
     * 支持kotlin调用
     * ClassSeeker.findClass("com.github.zimoyin.ffm") {
     * true
     * }
     *
     * @return 查找到的类
     ...
     * <p>
     * 支持kotlin 调用
     * ClassSeeker.findClass("com.github.zimoyin.ffm",null) {
     * true
     * }
     *
     * @param packetOrClsName 包名 或者类名
